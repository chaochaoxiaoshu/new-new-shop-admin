    ...
    <TableLayout
      header={
        <TableLayout.Header>
          ...
          >
            <Select.Option value={FreeGiftsStatus.未开始}>未开始</Select.Option>
            <Select.Option value={FreeGiftsStatus.进行中}>进行中</Select.Option>
            <Select.Option value={FreeGiftsStatus.已结束}>已结束</Select.Option>
          </Select>
          <Button
            type='primary'
