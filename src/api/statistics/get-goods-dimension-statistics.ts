...
export type GetGoodsDimensionStatisticsReq = {
  order_id?: string
  p_mobile?: string
  start_time?: number
  end_time?: number
  refund_start_time?: number
...
export type GetGoodsDimensionStatisticsRes = Partial<{
...
export const getGoodsDimensionStatistics = (
  req: GetGoodsDimensionStatisticsReq
) =>
  api
    .get<PaginatedResponse<GetGoodsDimensionStatisticsRes>>(
